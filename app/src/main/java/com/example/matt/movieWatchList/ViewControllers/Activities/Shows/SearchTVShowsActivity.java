                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.movie_watch_list_menu_item:
                                Intent watchListIntent = new Intent(SearchTVShowsActivity.this, TVShowWatchListActivity.class);
                                startActivity(watchListIntent);
                                return true;

                            case R.id.movie_browse_menu_item:
                                Intent browseIntent = new Intent(SearchTVShowsActivity.this, BrowseMoviesActivity.class);
                            ...
                            case R.id.settings_menu_item:
                                Intent settingsIntent = new Intent(SearchTVShowsActivity.this, SettingsActivity.class);
