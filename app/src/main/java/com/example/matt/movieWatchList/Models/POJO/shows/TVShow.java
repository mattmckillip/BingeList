...
public class TVShow {
    ...
    public JSONShow convertToRealm() {
        JSONShow returnShow = new JSONShow();
        returnShow.setBackdropPath(getBackdropPath());
        returnShow.setName(getName());
        returnShow.setId(getId());
        returnShow.setOnWatchList(false);
        returnShow.setOverview(getOverview());
        returnShow.setOriginalLanguage(getOriginalLanguage());
        returnShow.setPopularity(getPopularity());
        returnShow.setWatched(false);
        returnShow.setStatus(getStatus());
        returnShow.setPosterPath(getPosterPath());
        returnShow.setVoteAverage(getVoteAverage());
        returnShow.setFirstAirDate(getFirstAirDate());
        returnShow.setLastAirDate(getLastAirDate());
        returnShow.setNumberOfEpisodes(getNumberOfEpisodes());
        returnShow.setNumberOfSeasons(getNumberOfSeasons());
