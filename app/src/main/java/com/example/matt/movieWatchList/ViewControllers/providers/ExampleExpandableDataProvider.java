...
public class ExampleExpandableDataProvider extends AbstractExpandableDataProvider {
    ...
    public ExampleExpandableDataProvider() {
        ...
        final String[] childList = {"Epidsode 1", "Epidsode 2","Epidsode 3","Epidsode 4","Epidsode 5"};
        final String[] groupList = {"Season 1", "Season 2","Season 3","Season 4","Season 5"};
        ...
        for (int i = 0; i < groupList.length; i++) {
            ...
            final String groupText = groupList[i];
            ...
            for (int j = 0; j < childList.length; j++) {
                ...
                final String childText = childList[j];
